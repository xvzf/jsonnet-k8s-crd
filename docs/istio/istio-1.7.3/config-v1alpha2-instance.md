---
permalink: /istio/istio-1.7.3/config/v1alpha2/instance/
---
...
* [`obj spec`](#obj-spec)
  * [`fn withAttributeBindings(attributeBindings)`](#fn-specwithattributebindings)
  * [`fn withAttributeBindingsMixin(attributeBindings)`](#fn-specwithattributebindingsmixin)
  * [`fn withCompiledTemplate(compiledTemplate)`](#fn-specwithcompiledtemplate)
...
### fn spec.withAttributeBindings

```ts
withAttributeBindings(attributeBindings)
```



### fn spec.withAttributeBindingsMixin

```ts
withAttributeBindingsMixin(attributeBindings)
```
