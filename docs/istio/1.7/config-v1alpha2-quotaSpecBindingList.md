---
permalink: /istio/1.7/config/v1alpha2/quotaSpecBindingList/
---

# package quotaSpecBindingList
...
new returns an instance of Quotaspecbindinglist
...
List of quotaspecbindings. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
