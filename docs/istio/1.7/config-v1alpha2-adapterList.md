---
permalink: /istio/1.7/config/v1alpha2/adapterList/
---
...
new returns an instance of Adapterlist
...
List of adapters. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
