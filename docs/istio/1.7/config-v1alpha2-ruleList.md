---
permalink: /istio/1.7/config/v1alpha2/ruleList/
---
...
new returns an instance of Rulelist
...
List of rules. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
