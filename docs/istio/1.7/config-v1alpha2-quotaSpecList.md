---
permalink: /istio/1.7/config/v1alpha2/quotaSpecList/
---

# package quotaSpecList
...
new returns an instance of Quotaspeclist
...
List of quotaspecs. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
