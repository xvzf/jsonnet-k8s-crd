---
permalink: /istio/1.7/install/v1alpha1/istioOperatorList/
---

# package istioOperatorList

IstioOperatorList is a list of IstioOperator
...
new returns an instance of Istiooperatorlist
...
List of istiooperators. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
