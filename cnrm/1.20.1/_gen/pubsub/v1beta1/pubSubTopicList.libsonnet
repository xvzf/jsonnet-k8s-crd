{
  ...
  '#':: d.pkg(name='pubSubTopicList', url='', help='PubSubTopicList is a list of PubSubTopic'),
  ...
  '#new':: d.fn(help='new returns an instance of Pubsubtopiclist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
