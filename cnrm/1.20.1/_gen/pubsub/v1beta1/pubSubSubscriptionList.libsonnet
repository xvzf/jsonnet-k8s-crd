{
  ...
  '#':: d.pkg(name='pubSubSubscriptionList', url='', help='PubSubSubscriptionList is a list of PubSubSubscription'),
  ...
  '#new':: d.fn(help='new returns an instance of Pubsubsubscriptionlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
