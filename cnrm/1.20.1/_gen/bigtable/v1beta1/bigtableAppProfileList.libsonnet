{
  ...
  '#':: d.pkg(name='bigtableAppProfileList', url='', help='BigtableAppProfileList is a list of BigtableAppProfile'),
  ...
  '#new':: d.fn(help='new returns an instance of Bigtableappprofilelist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
