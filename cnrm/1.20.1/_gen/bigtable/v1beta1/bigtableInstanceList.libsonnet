{
  ...
  '#':: d.pkg(name='bigtableInstanceList', url='', help='BigtableInstanceList is a list of BigtableInstance'),
  ...
  '#new':: d.fn(help='new returns an instance of Bigtableinstancelist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
