{
  ...
  '#':: d.pkg(name='bigtableTableList', url='', help='BigtableTableList is a list of BigtableTable'),
  ...
  '#new':: d.fn(help='new returns an instance of Bigtabletablelist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
