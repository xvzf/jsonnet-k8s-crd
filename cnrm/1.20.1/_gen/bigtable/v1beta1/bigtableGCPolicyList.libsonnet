{
  ...
  '#':: d.pkg(name='bigtableGCPolicyList', url='', help='BigtableGCPolicyList is a list of BigtableGCPolicy'),
  ...
  '#new':: d.fn(help='new returns an instance of Bigtablegcpolicylist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
