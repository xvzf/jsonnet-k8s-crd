{
  ...
  '#':: d.pkg(name='redisInstanceList', url='', help='RedisInstanceList is a list of RedisInstance'),
  ...
  '#new':: d.fn(help='new returns an instance of Redisinstancelist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
