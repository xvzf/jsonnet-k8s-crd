{
  ...
  '#':: d.pkg(name='dataflowJobList', url='', help='DataflowJobList is a list of DataflowJob'),
  ...
  '#new':: d.fn(help='new returns an instance of Dataflowjoblist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
