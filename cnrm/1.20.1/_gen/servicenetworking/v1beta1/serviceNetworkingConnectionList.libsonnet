{
  ...
  '#':: d.pkg(name='serviceNetworkingConnectionList', url='', help='ServiceNetworkingConnectionList is a list of ServiceNetworkingConnection'),
  ...
  '#new':: d.fn(help='new returns an instance of Servicenetworkingconnectionlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
