{
  ...
  '#':: d.pkg(name='kmsKeyRingList', url='', help='KMSKeyRingList is a list of KMSKeyRing'),
  ...
  '#new':: d.fn(help='new returns an instance of Kmskeyringlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
