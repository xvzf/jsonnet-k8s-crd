{
  ...
  '#':: d.pkg(name='kmsCryptoKeyList', url='', help='KMSCryptoKeyList is a list of KMSCryptoKey'),
  ...
  '#new':: d.fn(help='new returns an instance of Kmscryptokeylist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
