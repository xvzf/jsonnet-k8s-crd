{
  ...
  '#':: d.pkg(name='bigQueryTableList', url='', help='BigQueryTableList is a list of BigQueryTable'),
  ...
  '#new':: d.fn(help='new returns an instance of Bigquerytablelist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
