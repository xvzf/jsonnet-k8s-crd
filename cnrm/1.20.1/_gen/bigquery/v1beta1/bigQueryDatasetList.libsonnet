{
  ...
  '#':: d.pkg(name='bigQueryDatasetList', url='', help='BigQueryDatasetList is a list of BigQueryDataset'),
  ...
  '#new':: d.fn(help='new returns an instance of Bigquerydatasetlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
