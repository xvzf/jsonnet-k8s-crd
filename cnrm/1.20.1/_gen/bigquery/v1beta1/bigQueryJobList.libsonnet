{
  ...
  '#':: d.pkg(name='bigQueryJobList', url='', help='BigQueryJobList is a list of BigQueryJob'),
  ...
  '#new':: d.fn(help='new returns an instance of Bigqueryjoblist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
