{
  ...
  '#':: d.pkg(name='serviceList', url='', help='ServiceList is a list of Service'),
  ...
  '#new':: d.fn(help='new returns an instance of Servicelist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
