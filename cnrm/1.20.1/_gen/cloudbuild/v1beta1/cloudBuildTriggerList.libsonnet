{
  ...
  '#':: d.pkg(name='cloudBuildTriggerList', url='', help='CloudBuildTriggerList is a list of CloudBuildTrigger'),
  ...
  '#new':: d.fn(help='new returns an instance of Cloudbuildtriggerlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
