{
  ...
  '#':: d.pkg(name='firestoreIndexList', url='', help='FirestoreIndexList is a list of FirestoreIndex'),
  ...
  '#new':: d.fn(help='new returns an instance of Firestoreindexlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
