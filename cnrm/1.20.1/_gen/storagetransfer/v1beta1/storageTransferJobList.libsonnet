{
  ...
  '#':: d.pkg(name='storageTransferJobList', url='', help='StorageTransferJobList is a list of StorageTransferJob'),
  ...
  '#new':: d.fn(help='new returns an instance of Storagetransferjoblist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
