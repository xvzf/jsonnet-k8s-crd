{
  ...
  '#':: d.pkg(name='storageDefaultObjectAccessControlList', url='', help='StorageDefaultObjectAccessControlList is a list of StorageDefaultObjectAccessControl'),
  ...
  '#new':: d.fn(help='new returns an instance of Storagedefaultobjectaccesscontrollist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
