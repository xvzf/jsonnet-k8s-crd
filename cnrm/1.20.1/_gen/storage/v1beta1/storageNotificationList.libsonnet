{
  ...
  '#':: d.pkg(name='storageNotificationList', url='', help='StorageNotificationList is a list of StorageNotification'),
  ...
  '#new':: d.fn(help='new returns an instance of Storagenotificationlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
