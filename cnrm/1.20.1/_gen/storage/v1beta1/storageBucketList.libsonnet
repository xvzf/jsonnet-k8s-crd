{
  ...
  '#':: d.pkg(name='storageBucketList', url='', help='StorageBucketList is a list of StorageBucket'),
  ...
  '#new':: d.fn(help='new returns an instance of Storagebucketlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
