{
  ...
  '#':: d.pkg(name='storageBucketAccessControlList', url='', help='StorageBucketAccessControlList is a list of StorageBucketAccessControl'),
  ...
  '#new':: d.fn(help='new returns an instance of Storagebucketaccesscontrollist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
