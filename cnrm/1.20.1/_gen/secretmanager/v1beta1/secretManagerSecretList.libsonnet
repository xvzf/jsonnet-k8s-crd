{
  ...
  '#':: d.pkg(name='secretManagerSecretList', url='', help='SecretManagerSecretList is a list of SecretManagerSecret'),
  ...
  '#new':: d.fn(help='new returns an instance of Secretmanagersecretlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
