{
  ...
  '#':: d.pkg(name='secretManagerSecretVersionList', url='', help='SecretManagerSecretVersionList is a list of SecretManagerSecretVersion'),
  ...
  '#new':: d.fn(help='new returns an instance of Secretmanagersecretversionlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
