{
  ...
  '#':: d.pkg(name='iamPolicyMemberList', url='', help='IAMPolicyMemberList is a list of IAMPolicyMember'),
  ...
  '#new':: d.fn(help='new returns an instance of Iampolicymemberlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
