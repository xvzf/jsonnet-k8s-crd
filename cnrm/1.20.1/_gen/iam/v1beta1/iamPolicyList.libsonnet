{
  ...
  '#':: d.pkg(name='iamPolicyList', url='', help='IAMPolicyList is a list of IAMPolicy'),
  ...
  '#new':: d.fn(help='new returns an instance of Iampolicylist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
