{
  ...
  '#':: d.pkg(name='iamServiceAccountKeyList', url='', help='IAMServiceAccountKeyList is a list of IAMServiceAccountKey'),
  ...
  '#new':: d.fn(help='new returns an instance of Iamserviceaccountkeylist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
