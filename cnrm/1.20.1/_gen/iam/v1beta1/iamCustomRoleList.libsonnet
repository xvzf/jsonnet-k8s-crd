{
  ...
  '#':: d.pkg(name='iamCustomRoleList', url='', help='IAMCustomRoleList is a list of IAMCustomRole'),
  ...
  '#new':: d.fn(help='new returns an instance of Iamcustomrolelist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
