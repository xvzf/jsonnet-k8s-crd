{
  ...
  '#':: d.pkg(name='iamServiceAccountList', url='', help='IAMServiceAccountList is a list of IAMServiceAccount'),
  ...
  '#new':: d.fn(help='new returns an instance of Iamserviceaccountlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
