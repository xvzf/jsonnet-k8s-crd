{
  ...
  '#':: d.pkg(name='sqlUserList', url='', help='SQLUserList is a list of SQLUser'),
  ...
  '#new':: d.fn(help='new returns an instance of Sqluserlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
