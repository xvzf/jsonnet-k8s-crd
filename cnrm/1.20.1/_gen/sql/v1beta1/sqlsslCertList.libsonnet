{
  ...
  '#':: d.pkg(name='sqlsslCertList', url='', help='SQLSSLCertList is a list of SQLSSLCert'),
  ...
  '#new':: d.fn(help='new returns an instance of Sqlsslcertlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
