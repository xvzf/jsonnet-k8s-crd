{
  ...
  '#':: d.pkg(name='sqlInstanceList', url='', help='SQLInstanceList is a list of SQLInstance'),
  ...
  '#new':: d.fn(help='new returns an instance of Sqlinstancelist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
