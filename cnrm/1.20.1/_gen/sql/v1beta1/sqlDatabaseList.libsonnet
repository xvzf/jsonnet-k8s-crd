{
  ...
  '#':: d.pkg(name='sqlDatabaseList', url='', help='SQLDatabaseList is a list of SQLDatabase'),
  ...
  '#new':: d.fn(help='new returns an instance of Sqldatabaselist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
