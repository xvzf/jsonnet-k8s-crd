{
  ...
  '#':: d.pkg(name='spannerInstanceList', url='', help='SpannerInstanceList is a list of SpannerInstance'),
  ...
  '#new':: d.fn(help='new returns an instance of Spannerinstancelist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
