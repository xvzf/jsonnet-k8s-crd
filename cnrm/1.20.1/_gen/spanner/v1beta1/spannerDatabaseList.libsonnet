{
  ...
  '#':: d.pkg(name='spannerDatabaseList', url='', help='SpannerDatabaseList is a list of SpannerDatabase'),
  ...
  '#new':: d.fn(help='new returns an instance of Spannerdatabaselist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
