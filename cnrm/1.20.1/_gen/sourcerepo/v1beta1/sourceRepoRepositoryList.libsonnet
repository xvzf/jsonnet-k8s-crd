{
  ...
  '#':: d.pkg(name='sourceRepoRepositoryList', url='', help='SourceRepoRepositoryList is a list of SourceRepoRepository'),
  ...
  '#new':: d.fn(help='new returns an instance of Sourcereporepositorylist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
