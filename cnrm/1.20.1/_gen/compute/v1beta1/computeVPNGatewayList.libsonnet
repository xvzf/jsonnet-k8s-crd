{
  ...
  '#':: d.pkg(name='computeVPNGatewayList', url='', help='ComputeVPNGatewayList is a list of ComputeVPNGateway'),
  ...
  '#new':: d.fn(help='new returns an instance of Computevpngatewaylist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
