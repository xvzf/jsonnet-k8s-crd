{
  ...
  '#':: d.pkg(name='computeImageList', url='', help='ComputeImageList is a list of ComputeImage'),
  ...
  '#new':: d.fn(help='new returns an instance of Computeimagelist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
