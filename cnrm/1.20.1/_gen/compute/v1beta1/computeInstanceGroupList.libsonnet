{
  ...
  '#':: d.pkg(name='computeInstanceGroupList', url='', help='ComputeInstanceGroupList is a list of ComputeInstanceGroup'),
  ...
  '#new':: d.fn(help='new returns an instance of Computeinstancegrouplist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
