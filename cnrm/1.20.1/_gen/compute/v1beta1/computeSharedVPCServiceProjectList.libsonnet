{
  ...
  '#':: d.pkg(name='computeSharedVPCServiceProjectList', url='', help='ComputeSharedVPCServiceProjectList is a list of ComputeSharedVPCServiceProject'),
  ...
  '#new':: d.fn(help='new returns an instance of Computesharedvpcserviceprojectlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
