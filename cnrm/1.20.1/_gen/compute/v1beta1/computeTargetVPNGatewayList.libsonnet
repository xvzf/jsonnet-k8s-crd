{
  ...
  '#':: d.pkg(name='computeTargetVPNGatewayList', url='', help='ComputeTargetVPNGatewayList is a list of ComputeTargetVPNGateway'),
  ...
  '#new':: d.fn(help='new returns an instance of Computetargetvpngatewaylist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
