{
  ...
  '#':: d.pkg(name='computeForwardingRuleList', url='', help='ComputeForwardingRuleList is a list of ComputeForwardingRule'),
  ...
  '#new':: d.fn(help='new returns an instance of Computeforwardingrulelist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
