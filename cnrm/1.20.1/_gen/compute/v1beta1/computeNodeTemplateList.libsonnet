{
  ...
  '#':: d.pkg(name='computeNodeTemplateList', url='', help='ComputeNodeTemplateList is a list of ComputeNodeTemplate'),
  ...
  '#new':: d.fn(help='new returns an instance of Computenodetemplatelist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
