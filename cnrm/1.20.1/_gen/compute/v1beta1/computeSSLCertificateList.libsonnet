{
  ...
  '#':: d.pkg(name='computeSSLCertificateList', url='', help='ComputeSSLCertificateList is a list of ComputeSSLCertificate'),
  ...
  '#new':: d.fn(help='new returns an instance of Computesslcertificatelist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
