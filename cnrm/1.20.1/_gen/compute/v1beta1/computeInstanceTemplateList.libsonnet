{
  ...
  '#':: d.pkg(name='computeInstanceTemplateList', url='', help='ComputeInstanceTemplateList is a list of ComputeInstanceTemplate'),
  ...
  '#new':: d.fn(help='new returns an instance of Computeinstancetemplatelist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
