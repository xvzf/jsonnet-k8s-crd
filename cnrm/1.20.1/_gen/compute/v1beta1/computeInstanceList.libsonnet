{
  ...
  '#':: d.pkg(name='computeInstanceList', url='', help='ComputeInstanceList is a list of ComputeInstance'),
  ...
  '#new':: d.fn(help='new returns an instance of Computeinstancelist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
