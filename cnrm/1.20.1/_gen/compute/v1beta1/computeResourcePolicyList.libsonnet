{
  ...
  '#':: d.pkg(name='computeResourcePolicyList', url='', help='ComputeResourcePolicyList is a list of ComputeResourcePolicy'),
  ...
  '#new':: d.fn(help='new returns an instance of Computeresourcepolicylist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
