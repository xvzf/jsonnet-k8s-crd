{
  ...
  '#':: d.pkg(name='computeNetworkPeeringList', url='', help='ComputeNetworkPeeringList is a list of ComputeNetworkPeering'),
  ...
  '#new':: d.fn(help='new returns an instance of Computenetworkpeeringlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
