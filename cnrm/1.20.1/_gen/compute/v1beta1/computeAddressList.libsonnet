{
  ...
  '#':: d.pkg(name='computeAddressList', url='', help='ComputeAddressList is a list of ComputeAddress'),
  ...
  '#new':: d.fn(help='new returns an instance of Computeaddresslist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
