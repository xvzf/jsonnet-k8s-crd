{
  ...
  '#':: d.pkg(name='computeRouterNATList', url='', help='ComputeRouterNATList is a list of ComputeRouterNAT'),
  ...
  '#new':: d.fn(help='new returns an instance of Computerouternatlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
