{
  ...
  '#':: d.pkg(name='computeNetworkEndpointGroupList', url='', help='ComputeNetworkEndpointGroupList is a list of ComputeNetworkEndpointGroup'),
  ...
  '#new':: d.fn(help='new returns an instance of Computenetworkendpointgrouplist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
