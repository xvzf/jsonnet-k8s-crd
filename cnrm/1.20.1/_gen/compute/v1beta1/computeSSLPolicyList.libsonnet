{
  ...
  '#':: d.pkg(name='computeSSLPolicyList', url='', help='ComputeSSLPolicyList is a list of ComputeSSLPolicy'),
  ...
  '#new':: d.fn(help='new returns an instance of Computesslpolicylist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
