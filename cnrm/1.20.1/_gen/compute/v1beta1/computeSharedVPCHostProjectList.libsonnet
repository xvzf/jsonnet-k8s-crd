{
  ...
  '#':: d.pkg(name='computeSharedVPCHostProjectList', url='', help='ComputeSharedVPCHostProjectList is a list of ComputeSharedVPCHostProject'),
  ...
  '#new':: d.fn(help='new returns an instance of Computesharedvpchostprojectlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
