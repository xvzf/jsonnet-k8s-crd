{
  ...
  '#':: d.pkg(name='computeBackendBucketList', url='', help='ComputeBackendBucketList is a list of ComputeBackendBucket'),
  ...
  '#new':: d.fn(help='new returns an instance of Computebackendbucketlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
