{
  ...
  '#':: d.pkg(name='computeTargetTCPProxyList', url='', help='ComputeTargetTCPProxyList is a list of ComputeTargetTCPProxy'),
  ...
  '#new':: d.fn(help='new returns an instance of Computetargettcpproxylist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
