{
  ...
  '#':: d.pkg(name='computeDiskList', url='', help='ComputeDiskList is a list of ComputeDisk'),
  ...
  '#new':: d.fn(help='new returns an instance of Computedisklist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
