{
  ...
  '#':: d.pkg(name='computeExternalVPNGatewayList', url='', help='ComputeExternalVPNGatewayList is a list of ComputeExternalVPNGateway'),
  ...
  '#new':: d.fn(help='new returns an instance of Computeexternalvpngatewaylist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
