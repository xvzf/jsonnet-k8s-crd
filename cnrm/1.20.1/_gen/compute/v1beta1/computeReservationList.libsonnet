{
  ...
  '#':: d.pkg(name='computeReservationList', url='', help='ComputeReservationList is a list of ComputeReservation'),
  ...
  '#new':: d.fn(help='new returns an instance of Computereservationlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
