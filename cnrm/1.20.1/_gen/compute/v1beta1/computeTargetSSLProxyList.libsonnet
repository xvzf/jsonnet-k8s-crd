{
  ...
  '#':: d.pkg(name='computeTargetSSLProxyList', url='', help='ComputeTargetSSLProxyList is a list of ComputeTargetSSLProxy'),
  ...
  '#new':: d.fn(help='new returns an instance of Computetargetsslproxylist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
