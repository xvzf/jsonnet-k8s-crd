{
  ...
  '#':: d.pkg(name='computeNodeGroupList', url='', help='ComputeNodeGroupList is a list of ComputeNodeGroup'),
  ...
  '#new':: d.fn(help='new returns an instance of Computenodegrouplist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
