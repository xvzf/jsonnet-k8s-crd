{
  ...
  '#':: d.pkg(name='computeRouteList', url='', help='ComputeRouteList is a list of ComputeRoute'),
  ...
  '#new':: d.fn(help='new returns an instance of Computeroutelist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
