{
  ...
  '#':: d.pkg(name='computeFirewallList', url='', help='ComputeFirewallList is a list of ComputeFirewall'),
  ...
  '#new':: d.fn(help='new returns an instance of Computefirewalllist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
