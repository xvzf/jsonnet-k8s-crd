{
  ...
  '#':: d.pkg(name='computeHealthCheckList', url='', help='ComputeHealthCheckList is a list of ComputeHealthCheck'),
  ...
  '#new':: d.fn(help='new returns an instance of Computehealthchecklist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
