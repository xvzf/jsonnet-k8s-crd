{
  ...
  '#':: d.pkg(name='computeHTTPHealthCheckList', url='', help='ComputeHTTPHealthCheckList is a list of ComputeHTTPHealthCheck'),
  ...
  '#new':: d.fn(help='new returns an instance of Computehttphealthchecklist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
