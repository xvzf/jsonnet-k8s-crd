{
  ...
  '#':: d.pkg(name='computeVPNTunnelList', url='', help='ComputeVPNTunnelList is a list of ComputeVPNTunnel'),
  ...
  '#new':: d.fn(help='new returns an instance of Computevpntunnellist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
