{
  ...
  '#':: d.pkg(name='computeRouterPeerList', url='', help='ComputeRouterPeerList is a list of ComputeRouterPeer'),
  ...
  '#new':: d.fn(help='new returns an instance of Computerouterpeerlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
