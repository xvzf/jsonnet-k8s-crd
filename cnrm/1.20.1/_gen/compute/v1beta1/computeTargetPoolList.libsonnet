{
  ...
  '#':: d.pkg(name='computeTargetPoolList', url='', help='ComputeTargetPoolList is a list of ComputeTargetPool'),
  ...
  '#new':: d.fn(help='new returns an instance of Computetargetpoollist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
