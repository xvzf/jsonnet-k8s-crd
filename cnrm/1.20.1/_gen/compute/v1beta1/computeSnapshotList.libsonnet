{
  ...
  '#':: d.pkg(name='computeSnapshotList', url='', help='ComputeSnapshotList is a list of ComputeSnapshot'),
  ...
  '#new':: d.fn(help='new returns an instance of Computesnapshotlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
