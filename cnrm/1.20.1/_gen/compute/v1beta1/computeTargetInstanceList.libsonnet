{
  ...
  '#':: d.pkg(name='computeTargetInstanceList', url='', help='ComputeTargetInstanceList is a list of ComputeTargetInstance'),
  ...
  '#new':: d.fn(help='new returns an instance of Computetargetinstancelist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
