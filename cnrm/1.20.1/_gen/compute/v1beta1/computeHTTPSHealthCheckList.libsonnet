{
  ...
  '#':: d.pkg(name='computeHTTPSHealthCheckList', url='', help='ComputeHTTPSHealthCheckList is a list of ComputeHTTPSHealthCheck'),
  ...
  '#new':: d.fn(help='new returns an instance of Computehttpshealthchecklist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
