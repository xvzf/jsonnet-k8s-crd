{
  ...
  '#':: d.pkg(name='computeTargetHTTPSProxyList', url='', help='ComputeTargetHTTPSProxyList is a list of ComputeTargetHTTPSProxy'),
  ...
  '#new':: d.fn(help='new returns an instance of Computetargethttpsproxylist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
