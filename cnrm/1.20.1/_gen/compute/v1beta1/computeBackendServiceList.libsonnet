{
  ...
  '#':: d.pkg(name='computeBackendServiceList', url='', help='ComputeBackendServiceList is a list of ComputeBackendService'),
  ...
  '#new':: d.fn(help='new returns an instance of Computebackendservicelist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
