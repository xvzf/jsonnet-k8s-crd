{
  ...
  '#':: d.pkg(name='computeRouterInterfaceList', url='', help='ComputeRouterInterfaceList is a list of ComputeRouterInterface'),
  ...
  '#new':: d.fn(help='new returns an instance of Computerouterinterfacelist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
