{
  ...
  '#':: d.pkg(name='computeURLMapList', url='', help='ComputeURLMapList is a list of ComputeURLMap'),
  ...
  '#new':: d.fn(help='new returns an instance of Computeurlmaplist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
