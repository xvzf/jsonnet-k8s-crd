{
  ...
  '#':: d.pkg(name='computeTargetHTTPProxyList', url='', help='ComputeTargetHTTPProxyList is a list of ComputeTargetHTTPProxy'),
  ...
  '#new':: d.fn(help='new returns an instance of Computetargethttpproxylist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
