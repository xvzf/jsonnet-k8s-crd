{
  ...
  '#':: d.pkg(name='computeRouterList', url='', help='ComputeRouterList is a list of ComputeRouter'),
  ...
  '#new':: d.fn(help='new returns an instance of Computerouterlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
