{
  ...
  '#':: d.pkg(name='computeSecurityPolicyList', url='', help='ComputeSecurityPolicyList is a list of ComputeSecurityPolicy'),
  ...
  '#new':: d.fn(help='new returns an instance of Computesecuritypolicylist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
