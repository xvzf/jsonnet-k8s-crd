{
  ...
  '#':: d.pkg(name='computeInterconnectAttachmentList', url='', help='ComputeInterconnectAttachmentList is a list of ComputeInterconnectAttachment'),
  ...
  '#new':: d.fn(help='new returns an instance of Computeinterconnectattachmentlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
