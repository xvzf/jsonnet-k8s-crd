{
  ...
  '#':: d.pkg(name='computeNetworkList', url='', help='ComputeNetworkList is a list of ComputeNetwork'),
  ...
  '#new':: d.fn(help='new returns an instance of Computenetworklist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
