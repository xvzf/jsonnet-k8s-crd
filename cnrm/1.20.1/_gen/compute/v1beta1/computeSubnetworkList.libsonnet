{
  ...
  '#':: d.pkg(name='computeSubnetworkList', url='', help='ComputeSubnetworkList is a list of ComputeSubnetwork'),
  ...
  '#new':: d.fn(help='new returns an instance of Computesubnetworklist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
