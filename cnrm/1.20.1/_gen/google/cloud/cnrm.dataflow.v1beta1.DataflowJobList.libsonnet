{
  ...
  '#':: d.pkg(name='cnrm.dataflow.v1beta1.DataflowJobList', url='', help='DataflowJobList is a list of DataflowJob'),
  ...
  '#new':: d.fn(help='new returns an instance of Cnrm.Dataflow.V1beta1.Dataflowjoblist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'dataflow.cnrm.cloud.google.com/v1beta1',
    kind: 'Cnrm.Dataflow.V1beta1.DataflowJobList'
  } + self.metadata.withName(name=name),
  '#withItems':: d.fn(help='List of dataflowjobs. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md', args=[d.arg(name='items', type=d.T.array)]),
  withItems(items): { items: if std.isArray(v=items) then items else [items] },
  '#withItemsMixin':: d.fn(help='List of dataflowjobs. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='items', type=d.T.array)]),
