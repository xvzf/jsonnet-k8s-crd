{
  ...
  '#':: d.pkg(name='cnrm.iam.v1beta1.IAMPolicyList', url='', help='IAMPolicyList is a list of IAMPolicy'),
  ...
  '#new':: d.fn(help='new returns an instance of Cnrm.Iam.V1beta1.Iampolicylist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'iam.cnrm.cloud.google.com/v1beta1',
    kind: 'Cnrm.Iam.V1beta1.IAMPolicyList'
  } + self.metadata.withName(name=name),
  '#withItems':: d.fn(help='List of iampolicies. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md', args=[d.arg(name='items', type=d.T.array)]),
  withItems(items): { items: if std.isArray(v=items) then items else [items] },
  '#withItemsMixin':: d.fn(help='List of iampolicies. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='items', type=d.T.array)]),
