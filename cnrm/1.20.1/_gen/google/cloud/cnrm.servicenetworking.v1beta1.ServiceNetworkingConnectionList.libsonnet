{
  ...
  '#':: d.pkg(name='cnrm.servicenetworking.v1beta1.ServiceNetworkingConnectionList', url='', help='ServiceNetworkingConnectionList is a list of ServiceNetworkingConnection'),
  ...
  '#new':: d.fn(help='new returns an instance of Cnrm.Servicenetworking.V1beta1.Servicenetworkingconnectionlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'servicenetworking.cnrm.cloud.google.com/v1beta1',
    kind: 'Cnrm.Servicenetworking.V1beta1.ServiceNetworkingConnectionList'
  } + self.metadata.withName(name=name),
  '#withItems':: d.fn(help='List of servicenetworkingconnections. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md', args=[d.arg(name='items', type=d.T.array)]),
  withItems(items): { items: if std.isArray(v=items) then items else [items] },
  '#withItemsMixin':: d.fn(help='List of servicenetworkingconnections. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='items', type=d.T.array)]),
