{
  ...
  '#':: d.pkg(name='cnrm.storage.v1beta1.StorageBucketAccessControlList', url='', help='StorageBucketAccessControlList is a list of StorageBucketAccessControl'),
  ...
  '#new':: d.fn(help='new returns an instance of Cnrm.Storage.V1beta1.Storagebucketaccesscontrollist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'storage.cnrm.cloud.google.com/v1beta1',
    kind: 'Cnrm.Storage.V1beta1.StorageBucketAccessControlList'
  } + self.metadata.withName(name=name),
  '#withItems':: d.fn(help='List of storagebucketaccesscontrols. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md', args=[d.arg(name='items', type=d.T.array)]),
  withItems(items): { items: if std.isArray(v=items) then items else [items] },
  '#withItemsMixin':: d.fn(help='List of storagebucketaccesscontrols. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='items', type=d.T.array)]),
