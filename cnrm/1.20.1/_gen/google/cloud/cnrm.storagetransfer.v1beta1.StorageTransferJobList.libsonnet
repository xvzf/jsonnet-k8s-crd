{
  ...
  '#':: d.pkg(name='cnrm.storagetransfer.v1beta1.StorageTransferJobList', url='', help='StorageTransferJobList is a list of StorageTransferJob'),
  ...
  '#new':: d.fn(help='new returns an instance of Cnrm.Storagetransfer.V1beta1.Storagetransferjoblist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'storagetransfer.cnrm.cloud.google.com/v1beta1',
    kind: 'Cnrm.Storagetransfer.V1beta1.StorageTransferJobList'
  } + self.metadata.withName(name=name),
  '#withItems':: d.fn(help='List of storagetransferjobs. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md', args=[d.arg(name='items', type=d.T.array)]),
  withItems(items): { items: if std.isArray(v=items) then items else [items] },
  '#withItemsMixin':: d.fn(help='List of storagetransferjobs. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='items', type=d.T.array)]),
