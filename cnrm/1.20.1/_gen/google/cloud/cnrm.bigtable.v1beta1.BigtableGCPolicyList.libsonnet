{
  ...
  '#':: d.pkg(name='cnrm.bigtable.v1beta1.BigtableGCPolicyList', url='', help='BigtableGCPolicyList is a list of BigtableGCPolicy'),
  ...
  '#new':: d.fn(help='new returns an instance of Cnrm.Bigtable.V1beta1.Bigtablegcpolicylist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'bigtable.cnrm.cloud.google.com/v1beta1',
    kind: 'Cnrm.Bigtable.V1beta1.BigtableGCPolicyList'
  } + self.metadata.withName(name=name),
  '#withItems':: d.fn(help='List of bigtablegcpolicies. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md', args=[d.arg(name='items', type=d.T.array)]),
  withItems(items): { items: if std.isArray(v=items) then items else [items] },
  '#withItemsMixin':: d.fn(help='List of bigtablegcpolicies. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='items', type=d.T.array)]),
