{
  ...
  '#':: d.pkg(name='cnrm.accesscontextmanager.v1beta1.AccessContextManagerAccessLevelList', url='', help='AccessContextManagerAccessLevelList is a list of AccessContextManagerAccessLevel'),
  ...
  '#new':: d.fn(help='new returns an instance of Cnrm.Accesscontextmanager.V1beta1.Accesscontextmanageraccesslevellist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'accesscontextmanager.cnrm.cloud.google.com/v1beta1',
    kind: 'Cnrm.Accesscontextmanager.V1beta1.AccessContextManagerAccessLevelList'
  } + self.metadata.withName(name=name),
  '#withItems':: d.fn(help='List of accesscontextmanageraccesslevels. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md', args=[d.arg(name='items', type=d.T.array)]),
  withItems(items): { items: if std.isArray(v=items) then items else [items] },
  '#withItemsMixin':: d.fn(help='List of accesscontextmanageraccesslevels. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='items', type=d.T.array)]),
