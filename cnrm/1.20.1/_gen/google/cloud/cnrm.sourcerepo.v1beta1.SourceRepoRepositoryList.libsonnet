{
  ...
  '#':: d.pkg(name='cnrm.sourcerepo.v1beta1.SourceRepoRepositoryList', url='', help='SourceRepoRepositoryList is a list of SourceRepoRepository'),
  ...
  '#new':: d.fn(help='new returns an instance of Cnrm.Sourcerepo.V1beta1.Sourcereporepositorylist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'sourcerepo.cnrm.cloud.google.com/v1beta1',
    kind: 'Cnrm.Sourcerepo.V1beta1.SourceRepoRepositoryList'
  } + self.metadata.withName(name=name),
  '#withItems':: d.fn(help='List of sourcereporepositories. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md', args=[d.arg(name='items', type=d.T.array)]),
  withItems(items): { items: if std.isArray(v=items) then items else [items] },
  '#withItemsMixin':: d.fn(help='List of sourcereporepositories. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='items', type=d.T.array)]),
