{
  ...
  '#':: d.pkg(name='cnrm.container.v1beta1.ContainerNodePoolList', url='', help='ContainerNodePoolList is a list of ContainerNodePool'),
  ...
  '#new':: d.fn(help='new returns an instance of Cnrm.Container.V1beta1.Containernodepoollist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'container.cnrm.cloud.google.com/v1beta1',
    kind: 'Cnrm.Container.V1beta1.ContainerNodePoolList'
  } + self.metadata.withName(name=name),
  '#withItems':: d.fn(help='List of containernodepools. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md', args=[d.arg(name='items', type=d.T.array)]),
  withItems(items): { items: if std.isArray(v=items) then items else [items] },
  '#withItemsMixin':: d.fn(help='List of containernodepools. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='items', type=d.T.array)]),
