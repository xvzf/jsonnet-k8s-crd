{
  ...
  '#':: d.pkg(name='cnrm.core.v1alpha1.ServiceMappingList', url='', help='ServiceMappingList is a list of ServiceMapping'),
  ...
  '#new':: d.fn(help='new returns an instance of Cnrm.Core.V1alpha1.Servicemappinglist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'core.cnrm.cloud.google.com/v1alpha1',
    kind: 'Cnrm.Core.V1alpha1.ServiceMappingList'
  } + self.metadata.withName(name=name),
  '#withItems':: d.fn(help='List of servicemappings. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md', args=[d.arg(name='items', type=d.T.array)]),
  withItems(items): { items: if std.isArray(v=items) then items else [items] },
  '#withItemsMixin':: d.fn(help='List of servicemappings. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='items', type=d.T.array)]),
