{
  ...
  '#':: d.pkg(name='cnrm.dns.v1beta1.DNSPolicyList', url='', help='DNSPolicyList is a list of DNSPolicy'),
  ...
  '#new':: d.fn(help='new returns an instance of Cnrm.Dns.V1beta1.Dnspolicylist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'dns.cnrm.cloud.google.com/v1beta1',
    kind: 'Cnrm.Dns.V1beta1.DNSPolicyList'
  } + self.metadata.withName(name=name),
  '#withItems':: d.fn(help='List of dnspolicies. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md', args=[d.arg(name='items', type=d.T.array)]),
  withItems(items): { items: if std.isArray(v=items) then items else [items] },
  '#withItemsMixin':: d.fn(help='List of dnspolicies. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='items', type=d.T.array)]),
