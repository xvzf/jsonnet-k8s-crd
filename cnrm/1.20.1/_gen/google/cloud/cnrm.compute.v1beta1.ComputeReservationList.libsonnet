{
  ...
  '#':: d.pkg(name='cnrm.compute.v1beta1.ComputeReservationList', url='', help='ComputeReservationList is a list of ComputeReservation'),
  ...
  '#new':: d.fn(help='new returns an instance of Cnrm.Compute.V1beta1.Computereservationlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'compute.cnrm.cloud.google.com/v1beta1',
    kind: 'Cnrm.Compute.V1beta1.ComputeReservationList'
  } + self.metadata.withName(name=name),
  '#withItems':: d.fn(help='List of computereservations. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md', args=[d.arg(name='items', type=d.T.array)]),
  withItems(items): { items: if std.isArray(v=items) then items else [items] },
  '#withItemsMixin':: d.fn(help='List of computereservations. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='items', type=d.T.array)]),
