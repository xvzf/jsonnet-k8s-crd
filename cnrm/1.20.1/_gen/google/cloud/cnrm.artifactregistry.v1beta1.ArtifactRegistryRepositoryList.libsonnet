{
  ...
  '#':: d.pkg(name='cnrm.artifactregistry.v1beta1.ArtifactRegistryRepositoryList', url='', help='ArtifactRegistryRepositoryList is a list of ArtifactRegistryRepository'),
  ...
  '#new':: d.fn(help='new returns an instance of Cnrm.Artifactregistry.V1beta1.Artifactregistryrepositorylist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'artifactregistry.cnrm.cloud.google.com/v1beta1',
    kind: 'Cnrm.Artifactregistry.V1beta1.ArtifactRegistryRepositoryList'
  } + self.metadata.withName(name=name),
  '#withItems':: d.fn(help='List of artifactregistryrepositories. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md', args=[d.arg(name='items', type=d.T.array)]),
  withItems(items): { items: if std.isArray(v=items) then items else [items] },
  '#withItemsMixin':: d.fn(help='List of artifactregistryrepositories. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='items', type=d.T.array)]),
