{
  ...
  '#':: d.pkg(name='cnrm.pubsub.v1beta1.PubSubTopicList', url='', help='PubSubTopicList is a list of PubSubTopic'),
  ...
  '#new':: d.fn(help='new returns an instance of Cnrm.Pubsub.V1beta1.Pubsubtopiclist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'pubsub.cnrm.cloud.google.com/v1beta1',
    kind: 'Cnrm.Pubsub.V1beta1.PubSubTopicList'
  } + self.metadata.withName(name=name),
  '#withItems':: d.fn(help='List of pubsubtopics. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md', args=[d.arg(name='items', type=d.T.array)]),
  withItems(items): { items: if std.isArray(v=items) then items else [items] },
  '#withItemsMixin':: d.fn(help='List of pubsubtopics. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='items', type=d.T.array)]),
