{
  ...
  '#':: d.pkg(name='cnrm.accesscontextmanager.v1beta1.AccessContextManagerAccessPolicyList', url='', help='AccessContextManagerAccessPolicyList is a list of AccessContextManagerAccessPolicy'),
  ...
  '#new':: d.fn(help='new returns an instance of Cnrm.Accesscontextmanager.V1beta1.Accesscontextmanageraccesspolicylist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'accesscontextmanager.cnrm.cloud.google.com/v1beta1',
    kind: 'Cnrm.Accesscontextmanager.V1beta1.AccessContextManagerAccessPolicyList'
