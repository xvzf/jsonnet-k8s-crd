{
  ...
  '#':: d.pkg(name='cnrm.cloudbuild.v1beta1.CloudBuildTriggerList', url='', help='CloudBuildTriggerList is a list of CloudBuildTrigger'),
  ...
  '#new':: d.fn(help='new returns an instance of Cnrm.Cloudbuild.V1beta1.Cloudbuildtriggerlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'cloudbuild.cnrm.cloud.google.com/v1beta1',
    kind: 'Cnrm.Cloudbuild.V1beta1.CloudBuildTriggerList'
  } + self.metadata.withName(name=name),
  '#withItems':: d.fn(help='List of cloudbuildtriggers. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md', args=[d.arg(name='items', type=d.T.array)]),
  withItems(items): { items: if std.isArray(v=items) then items else [items] },
  '#withItemsMixin':: d.fn(help='List of cloudbuildtriggers. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='items', type=d.T.array)]),
