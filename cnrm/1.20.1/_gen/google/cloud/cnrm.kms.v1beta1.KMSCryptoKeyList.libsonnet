{
  ...
  '#':: d.pkg(name='cnrm.kms.v1beta1.KMSCryptoKeyList', url='', help='KMSCryptoKeyList is a list of KMSCryptoKey'),
  ...
  '#new':: d.fn(help='new returns an instance of Cnrm.Kms.V1beta1.Kmscryptokeylist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'kms.cnrm.cloud.google.com/v1beta1',
    kind: 'Cnrm.Kms.V1beta1.KMSCryptoKeyList'
  } + self.metadata.withName(name=name),
  '#withItems':: d.fn(help='List of kmscryptokeys. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md', args=[d.arg(name='items', type=d.T.array)]),
  withItems(items): { items: if std.isArray(v=items) then items else [items] },
  '#withItemsMixin':: d.fn(help='List of kmscryptokeys. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='items', type=d.T.array)]),
