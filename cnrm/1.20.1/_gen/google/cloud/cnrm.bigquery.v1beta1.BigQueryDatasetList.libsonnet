{
  ...
  '#':: d.pkg(name='cnrm.bigquery.v1beta1.BigQueryDatasetList', url='', help='BigQueryDatasetList is a list of BigQueryDataset'),
  ...
  '#new':: d.fn(help='new returns an instance of Cnrm.Bigquery.V1beta1.Bigquerydatasetlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'bigquery.cnrm.cloud.google.com/v1beta1',
    kind: 'Cnrm.Bigquery.V1beta1.BigQueryDatasetList'
  } + self.metadata.withName(name=name),
  '#withItems':: d.fn(help='List of bigquerydatasets. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md', args=[d.arg(name='items', type=d.T.array)]),
  withItems(items): { items: if std.isArray(v=items) then items else [items] },
  '#withItemsMixin':: d.fn(help='List of bigquerydatasets. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='items', type=d.T.array)]),
