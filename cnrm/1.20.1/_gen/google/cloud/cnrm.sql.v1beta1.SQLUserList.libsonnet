{
  ...
  '#':: d.pkg(name='cnrm.sql.v1beta1.SQLUserList', url='', help='SQLUserList is a list of SQLUser'),
  ...
  '#new':: d.fn(help='new returns an instance of Cnrm.Sql.V1beta1.Sqluserlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'sql.cnrm.cloud.google.com/v1beta1',
    kind: 'Cnrm.Sql.V1beta1.SQLUserList'
  } + self.metadata.withName(name=name),
  '#withItems':: d.fn(help='List of sqlusers. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md', args=[d.arg(name='items', type=d.T.array)]),
  withItems(items): { items: if std.isArray(v=items) then items else [items] },
  '#withItemsMixin':: d.fn(help='List of sqlusers. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='items', type=d.T.array)]),
