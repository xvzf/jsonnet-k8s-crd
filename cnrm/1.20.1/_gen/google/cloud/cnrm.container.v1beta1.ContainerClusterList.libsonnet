{
  ...
  '#':: d.pkg(name='cnrm.container.v1beta1.ContainerClusterList', url='', help='ContainerClusterList is a list of ContainerCluster'),
  ...
  '#new':: d.fn(help='new returns an instance of Cnrm.Container.V1beta1.Containerclusterlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'container.cnrm.cloud.google.com/v1beta1',
    kind: 'Cnrm.Container.V1beta1.ContainerClusterList'
  } + self.metadata.withName(name=name),
  '#withItems':: d.fn(help='List of containerclusters. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md', args=[d.arg(name='items', type=d.T.array)]),
  withItems(items): { items: if std.isArray(v=items) then items else [items] },
  '#withItemsMixin':: d.fn(help='List of containerclusters. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='items', type=d.T.array)]),
