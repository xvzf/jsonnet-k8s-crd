{
  ...
  '#':: d.pkg(name='cnrm.pubsub.v1beta1.PubSubSubscriptionList', url='', help='PubSubSubscriptionList is a list of PubSubSubscription'),
  ...
  '#new':: d.fn(help='new returns an instance of Cnrm.Pubsub.V1beta1.Pubsubsubscriptionlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'pubsub.cnrm.cloud.google.com/v1beta1',
    kind: 'Cnrm.Pubsub.V1beta1.PubSubSubscriptionList'
  } + self.metadata.withName(name=name),
  '#withItems':: d.fn(help='List of pubsubsubscriptions. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md', args=[d.arg(name='items', type=d.T.array)]),
  withItems(items): { items: if std.isArray(v=items) then items else [items] },
  '#withItemsMixin':: d.fn(help='List of pubsubsubscriptions. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='items', type=d.T.array)]),
