{
  ...
  '#':: d.pkg(name='cnrm.resourcemanager.v1beta1.FolderList', url='', help='FolderList is a list of Folder'),
  ...
  '#new':: d.fn(help='new returns an instance of Cnrm.Resourcemanager.V1beta1.Folderlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'resourcemanager.cnrm.cloud.google.com/v1beta1',
    kind: 'Cnrm.Resourcemanager.V1beta1.FolderList'
  } + self.metadata.withName(name=name),
  '#withItems':: d.fn(help='List of folders. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md', args=[d.arg(name='items', type=d.T.array)]),
  withItems(items): { items: if std.isArray(v=items) then items else [items] },
  '#withItemsMixin':: d.fn(help='List of folders. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='items', type=d.T.array)]),
