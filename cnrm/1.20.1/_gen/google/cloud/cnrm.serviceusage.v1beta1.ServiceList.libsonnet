{
  ...
  '#':: d.pkg(name='cnrm.serviceusage.v1beta1.ServiceList', url='', help='ServiceList is a list of Service'),
  ...
  '#new':: d.fn(help='new returns an instance of Cnrm.Serviceusage.V1beta1.Servicelist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'serviceusage.cnrm.cloud.google.com/v1beta1',
    kind: 'Cnrm.Serviceusage.V1beta1.ServiceList'
  } + self.metadata.withName(name=name),
  '#withItems':: d.fn(help='List of services. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md', args=[d.arg(name='items', type=d.T.array)]),
  withItems(items): { items: if std.isArray(v=items) then items else [items] },
  '#withItemsMixin':: d.fn(help='List of services. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='items', type=d.T.array)]),
