{
  ...
  '#':: d.pkg(name='cnrm.secretmanager.v1beta1.SecretManagerSecretVersionList', url='', help='SecretManagerSecretVersionList is a list of SecretManagerSecretVersion'),
  ...
  '#new':: d.fn(help='new returns an instance of Cnrm.Secretmanager.V1beta1.Secretmanagersecretversionlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'secretmanager.cnrm.cloud.google.com/v1beta1',
    kind: 'Cnrm.Secretmanager.V1beta1.SecretManagerSecretVersionList'
  } + self.metadata.withName(name=name),
  '#withItems':: d.fn(help='List of secretmanagersecretversions. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md', args=[d.arg(name='items', type=d.T.array)]),
  withItems(items): { items: if std.isArray(v=items) then items else [items] },
  '#withItemsMixin':: d.fn(help='List of secretmanagersecretversions. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='items', type=d.T.array)]),
