{
  ...
  '#':: d.pkg(name='cnrm.redis.v1beta1.RedisInstanceList', url='', help='RedisInstanceList is a list of RedisInstance'),
  ...
  '#new':: d.fn(help='new returns an instance of Cnrm.Redis.V1beta1.Redisinstancelist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'redis.cnrm.cloud.google.com/v1beta1',
    kind: 'Cnrm.Redis.V1beta1.RedisInstanceList'
  } + self.metadata.withName(name=name),
  '#withItems':: d.fn(help='List of redisinstances. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md', args=[d.arg(name='items', type=d.T.array)]),
  withItems(items): { items: if std.isArray(v=items) then items else [items] },
  '#withItemsMixin':: d.fn(help='List of redisinstances. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='items', type=d.T.array)]),
