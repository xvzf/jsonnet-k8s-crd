{
  ...
  '#':: d.pkg(name='cnrm.firestore.v1beta1.FirestoreIndexList', url='', help='FirestoreIndexList is a list of FirestoreIndex'),
  ...
  '#new':: d.fn(help='new returns an instance of Cnrm.Firestore.V1beta1.Firestoreindexlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'firestore.cnrm.cloud.google.com/v1beta1',
    kind: 'Cnrm.Firestore.V1beta1.FirestoreIndexList'
  } + self.metadata.withName(name=name),
  '#withItems':: d.fn(help='List of firestoreindexes. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md', args=[d.arg(name='items', type=d.T.array)]),
  withItems(items): { items: if std.isArray(v=items) then items else [items] },
  '#withItemsMixin':: d.fn(help='List of firestoreindexes. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='items', type=d.T.array)]),
