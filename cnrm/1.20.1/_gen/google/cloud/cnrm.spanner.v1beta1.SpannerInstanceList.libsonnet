{
  ...
  '#':: d.pkg(name='cnrm.spanner.v1beta1.SpannerInstanceList', url='', help='SpannerInstanceList is a list of SpannerInstance'),
  ...
  '#new':: d.fn(help='new returns an instance of Cnrm.Spanner.V1beta1.Spannerinstancelist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'spanner.cnrm.cloud.google.com/v1beta1',
    kind: 'Cnrm.Spanner.V1beta1.SpannerInstanceList'
  } + self.metadata.withName(name=name),
  '#withItems':: d.fn(help='List of spannerinstances. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md', args=[d.arg(name='items', type=d.T.array)]),
  withItems(items): { items: if std.isArray(v=items) then items else [items] },
  '#withItemsMixin':: d.fn(help='List of spannerinstances. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='items', type=d.T.array)]),
