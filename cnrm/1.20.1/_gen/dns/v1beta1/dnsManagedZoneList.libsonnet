{
  ...
  '#':: d.pkg(name='dnsManagedZoneList', url='', help='DNSManagedZoneList is a list of DNSManagedZone'),
  ...
  '#new':: d.fn(help='new returns an instance of Dnsmanagedzonelist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
