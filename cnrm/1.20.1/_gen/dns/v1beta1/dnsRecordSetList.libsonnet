{
  ...
  '#':: d.pkg(name='dnsRecordSetList', url='', help='DNSRecordSetList is a list of DNSRecordSet'),
  ...
  '#new':: d.fn(help='new returns an instance of Dnsrecordsetlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
