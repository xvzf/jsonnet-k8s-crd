{
  ...
  '#':: d.pkg(name='dnsPolicyList', url='', help='DNSPolicyList is a list of DNSPolicy'),
  ...
  '#new':: d.fn(help='new returns an instance of Dnspolicylist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
