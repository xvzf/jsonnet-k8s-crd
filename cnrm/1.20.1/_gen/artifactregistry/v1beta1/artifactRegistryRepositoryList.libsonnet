{
  ...
  '#':: d.pkg(name='artifactRegistryRepositoryList', url='', help='ArtifactRegistryRepositoryList is a list of ArtifactRegistryRepository'),
  ...
  '#new':: d.fn(help='new returns an instance of Artifactregistryrepositorylist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
