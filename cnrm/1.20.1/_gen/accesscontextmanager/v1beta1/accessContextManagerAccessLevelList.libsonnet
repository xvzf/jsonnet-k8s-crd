{
  ...
  '#':: d.pkg(name='accessContextManagerAccessLevelList', url='', help='AccessContextManagerAccessLevelList is a list of AccessContextManagerAccessLevel'),
  ...
  '#new':: d.fn(help='new returns an instance of Accesscontextmanageraccesslevellist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
