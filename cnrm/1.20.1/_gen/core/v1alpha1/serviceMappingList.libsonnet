{
  ...
  '#':: d.pkg(name='serviceMappingList', url='', help='ServiceMappingList is a list of ServiceMapping'),
  ...
  '#new':: d.fn(help='new returns an instance of Servicemappinglist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
