{
  ...
  '#':: d.pkg(name='projectList', url='', help='ProjectList is a list of Project'),
  ...
  '#new':: d.fn(help='new returns an instance of Projectlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
