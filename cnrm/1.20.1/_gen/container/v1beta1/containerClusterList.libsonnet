{
  ...
  '#':: d.pkg(name='containerClusterList', url='', help='ContainerClusterList is a list of ContainerCluster'),
  ...
  '#new':: d.fn(help='new returns an instance of Containerclusterlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
