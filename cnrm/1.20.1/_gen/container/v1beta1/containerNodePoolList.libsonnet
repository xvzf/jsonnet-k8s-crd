{
  ...
  '#':: d.pkg(name='containerNodePoolList', url='', help='ContainerNodePoolList is a list of ContainerNodePool'),
  ...
  '#new':: d.fn(help='new returns an instance of Containernodepoollist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
