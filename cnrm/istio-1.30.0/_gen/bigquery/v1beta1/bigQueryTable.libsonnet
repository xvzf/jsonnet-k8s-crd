{
  ...
  spec: {
    ...
    externalDataConfiguration: {
      ...
      '#withSourceFormat':: d.fn(help='The data format. Supported values are: "CSV", "GOOGLE_SHEETS", "NEWLINE_DELIMITED_JSON", "AVRO", "PARQUET", and "DATASTORE_BACKUP". To use "GOOGLE_SHEETS" the scopes must include "googleapis.com/auth/drive.readonly".', args=[d.arg(name='sourceFormat', type=d.T.string)]),
