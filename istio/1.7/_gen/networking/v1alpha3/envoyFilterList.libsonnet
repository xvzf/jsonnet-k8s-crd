{
  ...
  '#':: d.pkg(name='envoyFilterList', url='', help='EnvoyFilterList is a list of EnvoyFilter'),
  ...
  '#new':: d.fn(help='new returns an instance of Envoyfilterlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
