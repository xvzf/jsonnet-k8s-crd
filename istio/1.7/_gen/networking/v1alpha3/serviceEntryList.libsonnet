{
  ...
  '#':: d.pkg(name='serviceEntryList', url='', help='ServiceEntryList is a list of ServiceEntry'),
  ...
  '#new':: d.fn(help='new returns an instance of Serviceentrylist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
