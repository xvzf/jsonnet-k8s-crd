{
  ...
  '#':: d.pkg(name='virtualServiceList', url='', help='VirtualServiceList is a list of VirtualService'),
  ...
  '#new':: d.fn(help='new returns an instance of Virtualservicelist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
