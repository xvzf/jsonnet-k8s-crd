{
  ...
  '#':: d.pkg(name='destinationRuleList', url='', help='DestinationRuleList is a list of DestinationRule'),
  ...
  '#new':: d.fn(help='new returns an instance of Destinationrulelist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
