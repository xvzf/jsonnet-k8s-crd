{
  ...
  '#':: d.pkg(name='sidecarList', url='', help='SidecarList is a list of Sidecar'),
  ...
  '#new':: d.fn(help='new returns an instance of Sidecarlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
