{
  ...
  '#':: d.pkg(name='gatewayList', url='', help='GatewayList is a list of Gateway'),
  ...
  '#new':: d.fn(help='new returns an instance of Gatewaylist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
