{
  ...
  '#':: d.pkg(name='workloadEntryList', url='', help='WorkloadEntryList is a list of WorkloadEntry'),
  ...
  '#new':: d.fn(help='new returns an instance of Workloadentrylist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
