{
  ...
  '#':: d.pkg(name='httpapiSpecList', url='', help='HTTPAPISpecList is a list of HTTPAPISpec'),
  ...
  '#new':: d.fn(help='new returns an instance of Httpapispeclist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'config.istio.io/v1alpha2',
    kind: 'HttpapiSpecList'
