{
  ...
  '#':: d.pkg(name='attributemanifestList', url='', help='attributemanifestList is a list of attributemanifest'),
  ...
  '#new':: d.fn(help='new returns an instance of Attributemanifestlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'config.istio.io/v1alpha2',
    kind: 'AttributemanifestList'
