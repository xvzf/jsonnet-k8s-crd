{
  ...
  '#':: d.pkg(name='instanceList', url='', help='instanceList is a list of instance'),
  ...
  '#new':: d.fn(help='new returns an instance of Instancelist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
