{
  ...
  '#':: d.pkg(name='templateList', url='', help='templateList is a list of template'),
  ...
  '#new':: d.fn(help='new returns an instance of Templatelist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
