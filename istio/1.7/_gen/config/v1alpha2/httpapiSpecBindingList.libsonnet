{
  ...
  '#':: d.pkg(name='httpapiSpecBindingList', url='', help='HTTPAPISpecBindingList is a list of HTTPAPISpecBinding'),
  ...
  '#new':: d.fn(help='new returns an instance of Httpapispecbindinglist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'config.istio.io/v1alpha2',
    kind: 'HttpapiSpecBindingList'
