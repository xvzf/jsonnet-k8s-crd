{
  ...
  '#':: d.pkg(name='adapterList', url='', help='adapterList is a list of adapter'),
  ...
  '#new':: d.fn(help='new returns an instance of Adapterlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
