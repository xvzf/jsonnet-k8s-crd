{
  ...
  '#':: d.pkg(name='quotaSpecList', url='', help='QuotaSpecList is a list of QuotaSpec'),
  ...
  '#new':: d.fn(help='new returns an instance of Quotaspeclist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
