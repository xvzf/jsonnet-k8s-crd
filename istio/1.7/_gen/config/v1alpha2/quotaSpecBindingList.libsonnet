{
  ...
  '#':: d.pkg(name='quotaSpecBindingList', url='', help='QuotaSpecBindingList is a list of QuotaSpecBinding'),
  ...
  '#new':: d.fn(help='new returns an instance of Quotaspecbindinglist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'config.istio.io/v1alpha2',
    kind: 'QuotaSpecBindingList'
