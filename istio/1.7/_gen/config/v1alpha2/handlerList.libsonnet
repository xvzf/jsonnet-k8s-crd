{
  ...
  '#':: d.pkg(name='handlerList', url='', help='handlerList is a list of handler'),
  ...
  '#new':: d.fn(help='new returns an instance of Handlerlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
