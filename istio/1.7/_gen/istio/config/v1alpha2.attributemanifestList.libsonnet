{
  ...
  '#':: d.pkg(name='v1alpha2.attributemanifestList', url='', help='attributemanifestList is a list of attributemanifest'),
  ...
  '#new':: d.fn(help='new returns an instance of V1alpha2.Attributemanifestlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'config.istio.io/v1alpha2',
    kind: 'V1alpha2.AttributemanifestList'
  } + self.metadata.withName(name=name),
  '#withItems':: d.fn(help='List of attributemanifests. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md', args=[d.arg(name='items', type=d.T.array)]),
  withItems(items): { items: if std.isArray(v=items) then items else [items] },
  '#withItemsMixin':: d.fn(help='List of attributemanifests. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='items', type=d.T.array)]),
