{
  ...
  '#':: d.pkg(name='v1alpha2.adapterList', url='', help='adapterList is a list of adapter'),
  ...
  '#new':: d.fn(help='new returns an instance of V1alpha2.Adapterlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'config.istio.io/v1alpha2',
    kind: 'V1alpha2.AdapterList'
  } + self.metadata.withName(name=name),
  '#withItems':: d.fn(help='List of adapters. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md', args=[d.arg(name='items', type=d.T.array)]),
  withItems(items): { items: if std.isArray(v=items) then items else [items] },
  '#withItemsMixin':: d.fn(help='List of adapters. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='items', type=d.T.array)]),
