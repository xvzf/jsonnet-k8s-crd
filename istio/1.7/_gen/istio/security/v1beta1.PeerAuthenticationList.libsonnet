{
  ...
  '#':: d.pkg(name='v1beta1.PeerAuthenticationList', url='', help='PeerAuthenticationList is a list of PeerAuthentication'),
  ...
  '#new':: d.fn(help='new returns an instance of V1beta1.Peerauthenticationlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'security.istio.io/v1beta1',
    kind: 'V1beta1.PeerAuthenticationList'
  } + self.metadata.withName(name=name),
  '#withItems':: d.fn(help='List of peerauthentications. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md', args=[d.arg(name='items', type=d.T.array)]),
  withItems(items): { items: if std.isArray(v=items) then items else [items] },
  '#withItemsMixin':: d.fn(help='List of peerauthentications. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='items', type=d.T.array)]),
