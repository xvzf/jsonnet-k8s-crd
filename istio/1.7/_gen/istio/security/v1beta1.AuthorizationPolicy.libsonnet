{
  ...
  '#':: d.pkg(name='v1beta1.AuthorizationPolicy', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of V1beta1.Authorizationpolicy', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'security.istio.io/v1beta1',
    kind: 'V1beta1.AuthorizationPolicy'
