{
  ...
  '#':: d.pkg(name='v1beta1.AuthorizationPolicyList', url='', help='AuthorizationPolicyList is a list of AuthorizationPolicy'),
  ...
  '#new':: d.fn(help='new returns an instance of V1beta1.Authorizationpolicylist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'security.istio.io/v1beta1',
    kind: 'V1beta1.AuthorizationPolicyList'
  } + self.metadata.withName(name=name),
  '#withItems':: d.fn(help='List of authorizationpolicies. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md', args=[d.arg(name='items', type=d.T.array)]),
  withItems(items): { items: if std.isArray(v=items) then items else [items] },
  '#withItemsMixin':: d.fn(help='List of authorizationpolicies. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='items', type=d.T.array)]),
