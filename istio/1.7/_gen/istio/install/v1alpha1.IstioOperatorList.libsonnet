{
  ...
  '#':: d.pkg(name='v1alpha1.IstioOperatorList', url='', help='IstioOperatorList is a list of IstioOperator'),
  ...
  '#new':: d.fn(help='new returns an instance of V1alpha1.Istiooperatorlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'install.istio.io/v1alpha1',
    kind: 'V1alpha1.IstioOperatorList'
  } + self.metadata.withName(name=name),
  '#withItems':: d.fn(help='List of istiooperators. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md', args=[d.arg(name='items', type=d.T.array)]),
  withItems(items): { items: if std.isArray(v=items) then items else [items] },
  '#withItemsMixin':: d.fn(help='List of istiooperators. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='items', type=d.T.array)]),
