{
  ...
  '#':: d.pkg(name='v1beta1.ServiceEntryList', url='', help='ServiceEntryList is a list of ServiceEntry'),
  ...
  '#new':: d.fn(help='new returns an instance of V1beta1.Serviceentrylist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'networking.istio.io/v1beta1',
    kind: 'V1beta1.ServiceEntryList'
