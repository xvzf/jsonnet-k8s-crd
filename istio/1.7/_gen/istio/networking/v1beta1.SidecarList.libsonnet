{
  ...
  '#':: d.pkg(name='v1beta1.SidecarList', url='', help='SidecarList is a list of Sidecar'),
  ...
  '#new':: d.fn(help='new returns an instance of V1beta1.Sidecarlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'networking.istio.io/v1beta1',
    kind: 'V1beta1.SidecarList'
