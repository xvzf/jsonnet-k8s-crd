{
  ...
  '#':: d.pkg(name='v1alpha3.WorkloadEntry', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of V1alpha3.Workloadentry', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'networking.istio.io/v1alpha3',
    kind: 'V1alpha3.WorkloadEntry'
