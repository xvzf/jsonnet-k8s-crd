{
  ...
  '#':: d.pkg(name='v1beta1.WorkloadEntryList', url='', help='WorkloadEntryList is a list of WorkloadEntry'),
  ...
  '#new':: d.fn(help='new returns an instance of V1beta1.Workloadentrylist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'networking.istio.io/v1beta1',
    kind: 'V1beta1.WorkloadEntryList'
