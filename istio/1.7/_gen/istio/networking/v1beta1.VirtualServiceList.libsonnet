{
  ...
  '#':: d.pkg(name='v1beta1.VirtualServiceList', url='', help='VirtualServiceList is a list of VirtualService'),
  ...
  '#new':: d.fn(help='new returns an instance of V1beta1.Virtualservicelist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'networking.istio.io/v1beta1',
    kind: 'V1beta1.VirtualServiceList'
