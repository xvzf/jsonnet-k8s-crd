{
  ...
  '#':: d.pkg(name='v1beta1.DestinationRuleList', url='', help='DestinationRuleList is a list of DestinationRule'),
  ...
  '#new':: d.fn(help='new returns an instance of V1beta1.Destinationrulelist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'networking.istio.io/v1beta1',
    kind: 'V1beta1.DestinationRuleList'
