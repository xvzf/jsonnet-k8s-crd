{
  ...
  '#':: d.pkg(name='v1alpha3.ServiceEntry', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of V1alpha3.Serviceentry', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'networking.istio.io/v1alpha3',
    kind: 'V1alpha3.ServiceEntry'
  ...
  spec: {
    ...
    '#withResolution':: d.fn(help='Service discovery mode for the hosts.', args=[d.arg(name='resolution', type=d.T.string)]),
