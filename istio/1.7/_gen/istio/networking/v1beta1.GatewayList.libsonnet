{
  ...
  '#':: d.pkg(name='v1beta1.GatewayList', url='', help='GatewayList is a list of Gateway'),
  ...
  '#new':: d.fn(help='new returns an instance of V1beta1.Gatewaylist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'networking.istio.io/v1beta1',
    kind: 'V1beta1.GatewayList'
