{
  ...
  '#':: d.pkg(name='v1alpha3.ServiceEntryList', url='', help='ServiceEntryList is a list of ServiceEntry'),
  ...
  '#new':: d.fn(help='new returns an instance of V1alpha3.Serviceentrylist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'networking.istio.io/v1alpha3',
    kind: 'V1alpha3.ServiceEntryList'
  } + self.metadata.withName(name=name),
  '#withItems':: d.fn(help='List of serviceentries. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md', args=[d.arg(name='items', type=d.T.array)]),
  withItems(items): { items: if std.isArray(v=items) then items else [items] },
  '#withItemsMixin':: d.fn(help='List of serviceentries. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='items', type=d.T.array)]),
