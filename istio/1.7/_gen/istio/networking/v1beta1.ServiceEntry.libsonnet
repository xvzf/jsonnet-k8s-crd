{
  ...
  '#':: d.pkg(name='v1beta1.ServiceEntry', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of V1beta1.Serviceentry', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'networking.istio.io/v1beta1',
    kind: 'V1beta1.ServiceEntry'
