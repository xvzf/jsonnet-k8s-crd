{
  ...
  '#':: d.pkg(name='requestAuthenticationList', url='', help='RequestAuthenticationList is a list of RequestAuthentication'),
  ...
  '#new':: d.fn(help='new returns an instance of Requestauthenticationlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
