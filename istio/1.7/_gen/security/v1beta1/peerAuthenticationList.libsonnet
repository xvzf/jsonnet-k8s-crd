{
  ...
  '#':: d.pkg(name='peerAuthenticationList', url='', help='PeerAuthenticationList is a list of PeerAuthentication'),
  ...
  '#new':: d.fn(help='new returns an instance of Peerauthenticationlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
