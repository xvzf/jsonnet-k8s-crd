{
  ...
  '#':: d.pkg(name='authorizationPolicyList', url='', help='AuthorizationPolicyList is a list of AuthorizationPolicy'),
  ...
  '#new':: d.fn(help='new returns an instance of Authorizationpolicylist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
