{
  ...
  '#':: d.pkg(name='istioOperatorList', url='', help='IstioOperatorList is a list of IstioOperator'),
  ...
  '#new':: d.fn(help='new returns an instance of Istiooperatorlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'install.istio.io/v1alpha1',
    kind: 'IstioOperatorList'
